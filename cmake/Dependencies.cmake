...
if (USE_CLBLAS AND NOT USE_ISAAC)
  ...
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${CPPSHAREDLIB})
...
if (USE_CLBLAST)
  ...
  list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${CLBLAST_INCLUDE})
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${CLBLAST_LIB}/libclblast.a)
  list(APPEND Caffe_LINKER_LIBS PUBLIC ${CPPSHAREDLIB})
...
if(NOT APPLE)
  ...
  elseif(BLAS STREQUAL "Open" OR BLAS STREQUAL "open")
    if (USE_BLIS)
       list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${blis_INCLUDE_DIR})
       list(APPEND Caffe_LINKER_LIBS PUBLIC ${blis_LIB})
